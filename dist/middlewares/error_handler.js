...
var ErrorHandler = /*#__PURE__*/function () {
  ...
  return _createClass(ErrorHandler, [{
    key: "handleError",
    value: function () {
      var _handleError = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(error) {
    ...
    key: "isTrustedError",
    value: function isTrustedError(error) {
    ...
    key: "handleCastErrorDB",
    value: function handleCastErrorDB(err) {
    ...
    key: "handleDuplicateFieldsDB",
    value: function handleDuplicateFieldsDB(err) {
    ...
    key: "handleValidationErrorDB",
    value: function handleValidationErrorDB(err) {
    ...
    key: "sendErrorDev",
    value: function sendErrorDev(err, req, res) {
      // A) API
    ...
    key: "handleJWTExpiredError",
    value: function handleJWTExpiredError() {
    ...
    key: "sendErrorProd",
    value: function sendErrorProd(err, req, res) {
      if (req.originalUrl.startsWith("/api")) {
