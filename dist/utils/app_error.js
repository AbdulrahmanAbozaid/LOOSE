...
var AppError = /*#__PURE__*/function (_Error) {
  function AppError(description, statusCode) {
    var _this;
    var isOperational = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
    _classCallCheck(this, AppError);
    _this = _callSuper(this, AppError, [description]);
    _defineProperty(_this, "success", false);
    Object.setPrototypeOf(_this, (this instanceof AppError ? this.constructor : void 0).prototype);
