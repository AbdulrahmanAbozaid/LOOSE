...
export var generateToken = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(payload) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          duration = _args.length > 1 && _args[1] !== undefined ? _args[1] : process.env.TOKEN_DEV;
          if (payload) {
            _context.next = 3;
            break;
          }
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 5:
          ...
          return _context2.abrupt("return", {
            error: new AppError(_context2.t0.message, 400)
          });
        case 8:
        case "end":
